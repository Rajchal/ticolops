...
# Some development environments don't have python-socketio installed.
# Import it lazily and gracefully degrade if missing so the main app can
# still run using the native WebSocket endpoint.
try:
    import socketio
except Exception:
    socketio = None
